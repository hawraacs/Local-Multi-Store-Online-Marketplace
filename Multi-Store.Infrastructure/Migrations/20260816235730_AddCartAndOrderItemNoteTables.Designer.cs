...
namespace Multi_Store.Infrastructure.Migrations
{
    ...
    [Migration("20260816235730_AddCartAndOrderItemNoteTables")]
    partial class AddCartAndOrderItemNoteTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Multi_Store.Core.Entities.CartItemNote", b =>
                {
                    b.Property<int>("CartItemNoteID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("CartItemNoteID"));
                    ...
                    b.HasKey("CartItemNoteID");

                    b.ToTable("CartItemNotes");
                });
            ...
            modelBuilder.Entity("Multi_Store.Core.Entities.DeliveryAssignment", b =>
                {
                    ...
                    b.Property<bool>("IsHiddenByDeliveryPerson")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Multi_Store.Core.Entities.DeliveryReview", b =>
                {
                    b.Property<int>("DeliveryReviewID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("DeliveryReviewID"));
                    ...
                    b.ToTable("DeliveryReviews", t =>
                        {
                            t.HasCheckConstraint("CK_DeliveryReview_Rating", "Rating >= 1 AND Rating <= 5");
                        });
                });
            ...
            modelBuilder.Entity("Multi_Store.Core.Entities.ExplorePostHide", b =>
                {
                    b.Property<int>("ExplorePostHideID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ExplorePostHideID"));
                    ...
                    b.HasKey("ExplorePostHideID");

                    b.ToTable("ExplorePostHides");
                });

            modelBuilder.Entity("Multi_Store.Core.Entities.ExploreView", b =>
                {
                    b.Property<int>("ExploreViewID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ExploreViewID"));
            ...
            modelBuilder.Entity("Multi_Store.Core.Entities.OrderItem", b =>
                {
                    ...
                    b.Property<string>("StoreResponseStatus")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Multi_Store.Core.Entities.OrderItemNote", b =>
                {
                    b.Property<int>("OrderItemNoteID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("OrderItemNoteID"));
                    ...
                    b.HasKey("OrderItemNoteID");

                    b.ToTable("OrderItemNotes");
                });
            ...
            modelBuilder.Entity("Multi_Store.Core.Entities.Report", b =>
                {
                    ...
                    b.Property<int?>("ReporterCustomerID")
                        .HasColumnType("int");

                    b.Property<int?>("ReporterStoreID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Multi_Store.Core.Entities.StoreFollow", b =>
                {
                    b.Property<int>("StoreFollowID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("StoreFollowID"));
            ...
            modelBuilder.Entity("Multi_Store.Core.Entities.ProductBoost", b =>
                {
                    ...
                    b.HasOne("Multi_Store.Core.Entities.StorePayment", "StorePayment")
                        .WithMany()
            ...
            modelBuilder.Entity("Multi_Store.Core.Entities.RecentlyViewedProduct", b =>
                {
                    ...
                    b.HasOne("Multi_Store.Core.Entities.Product", null)
                        .WithMany("RecentlyViewedProducts")
                        .HasForeignKey("ProductID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Multi_Store.Core.Entities.Report", b =>
                {
                    b.HasOne("Multi_Store.Core.Entities.Customer", "ReporterCustomer")
                        .WithMany()
                        .HasForeignKey("ReporterCustomerID");

                    b.HasOne("Multi_Store.Core.Entities.Store", "ReporterStore")
                        .WithMany()
                        .HasForeignKey("ReporterStoreID");

                    b.Navigation("ReporterCustomer");

                    b.Navigation("ReporterStore");
                });
